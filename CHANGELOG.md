...
- [#208](https://github.com/green-code-initiative/ecoCode/issues/208) Improves build process and simplifies release management (now, just need to do a build on a tag checkout).
